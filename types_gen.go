...
func (z *A) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "A":
			{
				var tmp []byte
				tmp, bts, err = msgp.ReadBytesBytes(bts, ipToByte(z.A))
				z.A = byteToIP(tmp)
			}
			if err != nil {
				return
...
func (z *AAAA) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "AAAA":
			{
				var tmp []byte
				tmp, bts, err = msgp.ReadBytesBytes(bts, ipToByte(z.AAAA))
				z.AAAA = byteToIP(tmp)
			}
			if err != nil {
				return
...
func (z *Class) UnmarshalMsg(bts []byte) (o []byte, err error) {
	{
		var tmp uint16
		tmp, bts, err = msgp.ReadUint16Bytes(bts)
		(*z) = Class(tmp)
	}
	if err != nil {
		return
...
func (z *HIP) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for xvk := range z.RendezvousServers {
		o = msgp.AppendString(o, z.RendezvousServers[xvk])
	}
	return
}
...
func (z *HIP) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "RendezvousServers":
			...
			if cap(z.RendezvousServers) >= int(xsz) {
				z.RendezvousServers = z.RendezvousServers[:xsz]
			} else {
				z.RendezvousServers = make([]string, xsz)
			}
			for xvk := range z.RendezvousServers {
				z.RendezvousServers[xvk], bts, err = msgp.ReadStringBytes(bts)
				if err != nil {
					return
				}
			}
...
func (z *HIP) Msgsize() (s int) {
	...
	for xvk := range z.RendezvousServers {
		s += msgp.StringPrefixSize + len(z.RendezvousServers[xvk])
	}
	return
}
...
// MarshalMsg implements msgp.Marshaler
func (z *IPSECKEY) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 8
	// string "Hdr"
	...
	o = msgp.AppendString(o, hdrToEmpty(z.Hdr))
	// string "Precedence"
	o = append(o, 0xaa, 0x50, 0x72, 0x65, 0x63, 0x65, 0x64, 0x65, 0x6e, 0x63, 0x65)
	o = msgp.AppendUint8(o, z.Precedence)
	// string "GatewayType"
	o = append(o, 0xab, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65)
	o = msgp.AppendUint8(o, z.GatewayType)
	// string "Algorithm"
	o = append(o, 0xa9, 0x41, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d)
	o = msgp.AppendUint8(o, z.Algorithm)
	// string "GatewayA"
	o = append(o, 0xa8, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x41)
	o = msgp.AppendBytes(o, ipToByte(z.GatewayAAAA))
	// string "GatewayAAAA"
	o = append(o, 0xab, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x41, 0x41, 0x41, 0x41)
	o = msgp.AppendBytes(o, ipToByte(z.GatewayAAAA))
	// string "GatewayName"
	o = append(o, 0xab, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65)
	o = msgp.AppendString(o, z.GatewayName)
	// string "PublicKey"
	o = append(o, 0xa9, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79)
	o = msgp.AppendString(o, z.PublicKey)
	return
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *IPSECKEY) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var isz uint32
	isz, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for isz > 0 {
		...
		case "Precedence":
			z.Precedence, bts, err = msgp.ReadUint8Bytes(bts)
			if err != nil {
				return
			}
		case "GatewayType":
			z.GatewayType, bts, err = msgp.ReadUint8Bytes(bts)
			if err != nil {
				return
			}
		case "Algorithm":
		...
		case "GatewayA":
			{
				var tmp []byte
				tmp, bts, err = msgp.ReadBytesBytes(bts, ipToByte(z.GatewayAAAA))
				z.GatewayAAAA = byteToIP(tmp)
			}
			if err != nil {
				return
			}
		...
		case "GatewayName":
			z.GatewayName, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				return
			}
		case "PublicKey":
...
func (z *IPSECKEY) Msgsize() (s int) {
	s = 1 + 4 + msgp.StringPrefixSize + len(hdrToEmpty(z.Hdr)) + 11 + msgp.Uint8Size + 12 + msgp.Uint8Size + 10 + msgp.Uint8Size + 9 + msgp.BytesPrefixSize + len(ipToByte(z.GatewayAAAA)) + 12 + msgp.BytesPrefixSize + len(ipToByte(z.GatewayAAAA)) + 12 + msgp.StringPrefixSize + len(z.GatewayName) + 10 + msgp.StringPrefixSize + len(z.PublicKey)
	return
}
...
func (z *L32) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "Locator32":
			{
				var tmp []byte
				tmp, bts, err = msgp.ReadBytesBytes(bts, ipToByte(z.Locator32))
				z.Locator32 = byteToIP(tmp)
			}
			if err != nil {
				return
			}
...
func (z *NINFO) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for bzg := range z.ZSData {
		o = msgp.AppendString(o, z.ZSData[bzg])
	}
	return
}
...
func (z *NINFO) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "ZSData":
			...
			if cap(z.ZSData) >= int(xsz) {
				z.ZSData = z.ZSData[:xsz]
			} else {
				z.ZSData = make([]string, xsz)
			}
			for bzg := range z.ZSData {
				z.ZSData[bzg], bts, err = msgp.ReadStringBytes(bts)
				if err != nil {
					return
				}
			}
...
func (z *NINFO) Msgsize() (s int) {
	...
	for bzg := range z.ZSData {
		s += msgp.StringPrefixSize + len(z.ZSData[bzg])
	}
	return
}
...
func (z *NSEC) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for bai := range z.TypeBitMap {
		o = msgp.AppendUint16(o, z.TypeBitMap[bai])
	}
	return
}
...
func (z *NSEC) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "TypeBitMap":
			...
			if cap(z.TypeBitMap) >= int(xsz) {
				z.TypeBitMap = z.TypeBitMap[:xsz]
			} else {
				z.TypeBitMap = make([]uint16, xsz)
			}
			for bai := range z.TypeBitMap {
				z.TypeBitMap[bai], bts, err = msgp.ReadUint16Bytes(bts)
				if err != nil {
					return
				}
			}
...
func (z *NSEC3) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = append(o, 0xaa, 0x54, 0x79, 0x70, 0x65, 0x42, 0x69, 0x74, 0x4d, 0x61, 0x70)
	o = msgp.AppendArrayHeader(o, uint32(len(z.TypeBitMap)))
	for cmr := range z.TypeBitMap {
		o = msgp.AppendUint16(o, z.TypeBitMap[cmr])
	}
	return
}
...
func (z *NSEC3) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "TypeBitMap":
			...
			for cmr := range z.TypeBitMap {
				z.TypeBitMap[cmr], bts, err = msgp.ReadUint16Bytes(bts)
				if err != nil {
					return
				}
			}
...
func (z *SPF) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for ajw := range z.Txt {
		o = msgp.AppendString(o, z.Txt[ajw])
	}
	return
}
...
func (z *SPF) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "Txt":
			...
			if cap(z.Txt) >= int(xsz) {
				z.Txt = z.Txt[:xsz]
			} else {
				z.Txt = make([]string, xsz)
			}
			for ajw := range z.Txt {
				z.Txt[ajw], bts, err = msgp.ReadStringBytes(bts)
				if err != nil {
					return
				}
			}
...
func (z *SPF) Msgsize() (s int) {
	...
	for ajw := range z.Txt {
		s += msgp.StringPrefixSize + len(z.Txt[ajw])
	}
	return
}
...
func (z *TXT) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendArrayHeader(o, uint32(len(z.Txt)))
	for wht := range z.Txt {
		o = msgp.AppendString(o, z.Txt[wht])
	}
	return
}
...
func (z *TXT) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for isz > 0 {
		...
		case "Txt":
			...
			for wht := range z.Txt {
				z.Txt[wht], bts, err = msgp.ReadStringBytes(bts)
				if err != nil {
					return
				}
			}
...
func (z *TXT) Msgsize() (s int) {
	s = 1 + 4 + msgp.StringPrefixSize + len(hdrToEmpty(z.Hdr)) + 4 + msgp.ArrayHeaderSize
	for wht := range z.Txt {
		s += msgp.StringPrefixSize + len(z.Txt[wht])
	}
	return
}
...
// MarshalMsg implements msgp.Marshaler
func (z *WKS) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 4
	// string "Hdr"
	o = append(o, 0x84, 0xa3, 0x48, 0x64, 0x72)
	...
	// string "Address"
	o = append(o, 0xa7, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73)
	o = msgp.AppendBytes(o, ipToByte(z.Address))
	// string "Protocol"
	o = append(o, 0xa8, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c)
	o = msgp.AppendUint8(o, z.Protocol)
	// string "BitMap"
	o = append(o, 0xa6, 0x42, 0x69, 0x74, 0x4d, 0x61, 0x70)
	o = msgp.AppendArrayHeader(o, uint32(len(z.BitMap)))
	for hct := range z.BitMap {
		o = msgp.AppendUint16(o, z.BitMap[hct])
	}
	return
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *WKS) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var isz uint32
	isz, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for isz > 0 {
		...
		case "Address":
			{
				var tmp []byte
				tmp, bts, err = msgp.ReadBytesBytes(bts, ipToByte(z.Address))
				z.Address = byteToIP(tmp)
			}
			if err != nil {
				return
			}
		...
		case "BitMap":
			...
			if cap(z.BitMap) >= int(xsz) {
				z.BitMap = z.BitMap[:xsz]
			} else {
				z.BitMap = make([]uint16, xsz)
			}
			for hct := range z.BitMap {
				z.BitMap[hct], bts, err = msgp.ReadUint16Bytes(bts)
				if err != nil {
					return
				}
			}
...
func (z *WKS) Msgsize() (s int) {
	s = 1 + 4 + msgp.StringPrefixSize + len(hdrToEmpty(z.Hdr)) + 8 + msgp.BytesPrefixSize + len(ipToByte(z.Address)) + 9 + msgp.Uint8Size + 7 + msgp.ArrayHeaderSize + (len(z.BitMap) * (msgp.Uint16Size))
	return
}
